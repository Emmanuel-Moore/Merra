...
<div class="bodyWpr">
	...
	<div class="tpHdr diB">
		<div class="tpLft fL">
			<a class="hdSel cl1" onclick="">Top</a> / <a onclick="">All</a>
		</div>
		<div class="tpRgt tpSet fR cP" onclick="upTgle('tpMnu')">
			<span></span><span></span><span></span>
		</div>
		<div class="tpSetWpr fR">
			<ul id="tpMnu" class="tpMnu dN pA">
				<li onclick="tpMnux1()">Post</li>
				<li onclick="tpMnux2()">Photos</li>
				<li onclick="tpMnux3()">Videos</li>
				<li onclick="tpMnux4()">Trending</li>
			</ul>
		</div>
	</div>
	...
	<div class="dv2">
		<div class="flwWpr">
			<div class="tpRgt2 fR">top followers</div>
			<a href="user.php"><img src="img/temp/tempUsr.jpg"/></a>
			...
			<a href="user.php"><img src="img/temp/temp1d.jpg"/></a><br>
