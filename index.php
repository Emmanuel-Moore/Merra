...
<div class="bodyWpr">
	...
	<div class="lMnuWpr pF dN">
		...
		<div class="lMlr">
			<span onclick="lMnu1()">login</span> / 
			<span onclick="lMnu2()">signup</span> /  
			<span onclick="lMnu3()">forgot password</span>
		</div>
		<!-- login insert end -->
	...
	<div class="tpHdr diB">
		<div class="tpLft fL">
			<span onclick"tp1()">post</span>
			<span onclick"tp2()">photos</span>
			<span onclick"tp3()">videos</span>
		</div>
		<span class="tpRgt fR">followers</span>
	</div>
